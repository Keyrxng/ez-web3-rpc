...
describe('retryProxy fatal path', () => {
  ...
  const proxy = wrapWithRetry(base, { retryCount: 1, retryDelay: 1, getOrderedUrls: () => ['http://localhost:8555','http://localhost:8556','http://localhost:8557','http://localhost:8558'], chainId: 31337, rpcCallTimeout: 50, onLog: ()=>{} });
